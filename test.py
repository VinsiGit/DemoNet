...
# Example input
year = 1980
surface_area = 120.5  # in square meters

try:
    materials = get_materials_by_year_and_area(year, surface_area)
    print(f"Materials for year {year} and surface area {surface_area}m²:")
    for material, amount in materials.items():
        print(f"{material}: {amount*surface_area}")
